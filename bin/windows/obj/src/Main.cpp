...
HXLINE(   7)			 ::haxe::ui::HaxeUIApp app1 = app;
HXDLIN(   7)			app1->addComponent( ::MainView_obj::__alloc( HX_CTX ));
HXLINE(   9)			app->start();
            		}
            		HX_END_LOCAL_FUNC0((void))

            	HX_GC_STACKFRAME(&_hx_pos_e47a9afac0942eb9_4_main)
HXLINE(   5)		 ::haxe::ui::HaxeUIApp app =  ::haxe::ui::HaxeUIApp_obj::__alloc( HX_CTX ,null());
HXLINE(   6)		app->ready( ::Dynamic(new _hx_Closure_0(app)),null());
            	}
