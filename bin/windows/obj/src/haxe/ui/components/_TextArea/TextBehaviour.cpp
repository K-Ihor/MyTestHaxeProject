...
HX_DEFINE_STACK_FRAME(_hx_pos_f76e1717003544b4_200_new,"haxe.ui.components._TextArea.TextBehaviour","new",0xe884ee87,"haxe.ui.components._TextArea.TextBehaviour.new","haxe/ui/components/TextArea.hx",200,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_f76e1717003544b4_201_validateData,"haxe.ui.components._TextArea.TextBehaviour","validateData",0xa576bad9,"haxe.ui.components._TextArea.TextBehaviour.validateData","haxe/ui/components/TextArea.hx",201,0xfe441d7d)
namespace haxe{
namespace ui{
...
void TextBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_f76e1717003544b4_200_new)
...
void TextBehaviour_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_f76e1717003544b4_201_validateData)
HXLINE( 202)		 ::haxe::ui::components::TextArea textarea = ::hx::TCast<  ::haxe::ui::components::TextArea >::cast(this->_component);
HXLINE( 203)		::String text;
HXDLIN( 203)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 203)			text = ::haxe::ui::util::_Variant::Variant_Impl__obj::toString(this->_value);
            		}
            		else {
HXLINE( 203)			text = HX_("",00,00,00,00);
            		}
HXLINE( 204)		::haxe::ui::components::_TextArea::TextAreaHelper_obj::validateText(textarea,text);
HXLINE( 205)		if ((textarea->get_autoScrollToBottom() == true)) {
HXLINE( 206)			textarea->scrollToBottom();
            		}
            	}
