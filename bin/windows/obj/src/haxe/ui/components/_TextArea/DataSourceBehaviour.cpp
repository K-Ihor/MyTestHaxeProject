...
HX_DEFINE_STACK_FRAME(_hx_pos_dbe83e72de68a548_176_new,"haxe.ui.components._TextArea.DataSourceBehaviour","new",0x07568b4f,"haxe.ui.components._TextArea.DataSourceBehaviour.new","haxe/ui/components/TextArea.hx",176,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_dbe83e72de68a548_177_set,"haxe.ui.components._TextArea.DataSourceBehaviour","set",0x075a5691,"haxe.ui.components._TextArea.DataSourceBehaviour.set","haxe/ui/components/TextArea.hx",177,0xfe441d7d)
HX_LOCAL_STACK_FRAME(_hx_pos_dbe83e72de68a548_182_get,"haxe.ui.components._TextArea.DataSourceBehaviour","get",0x07513b85,"haxe.ui.components._TextArea.DataSourceBehaviour.get","haxe/ui/components/TextArea.hx",182,0xfe441d7d)
namespace haxe{
namespace ui{
...
void DataSourceBehaviour_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_dbe83e72de68a548_176_new)
...
void DataSourceBehaviour_obj::set( ::haxe::ui::util::VariantType value){
            	HX_STACKFRAME(&_hx_pos_dbe83e72de68a548_177_set)
HXLINE( 178)		this->_value = value;
HXLINE( 179)		 ::haxe::ui::core::TextInput _hx_tmp = this->_component->getTextInput();
HXDLIN( 179)		_hx_tmp->set_dataSource(::haxe::ui::util::_Variant::Variant_Impl__obj::toDataSource(value));
            	}


 ::haxe::ui::util::VariantType DataSourceBehaviour_obj::get(){
            	HX_GC_STACKFRAME(&_hx_pos_dbe83e72de68a548_182_get)
HXLINE( 183)		bool _hx_tmp;
HXDLIN( 183)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 183)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
HXLINE( 183)			_hx_tmp = true;
            		}
HXDLIN( 183)		if (_hx_tmp) {
HXLINE( 184)			this->_value = ::haxe::ui::util::_Variant::Variant_Impl__obj::fromDataSource( ::haxe::ui::data::ArrayDataSource_obj::__alloc( HX_CTX ,null()));
HXLINE( 185)			this->set(this->_value);
            		}
HXLINE( 187)		return this->_value;
            	}
