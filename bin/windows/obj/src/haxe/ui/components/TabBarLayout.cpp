...
HXLINE(  51)			Float _hx_tmp = this->_component->get_width();
HXDLIN(  51)			filler->set_width((_hx_tmp - container->get_width()));
...
HXLINE(  59)				if ((button->get_height() > max)) {
HXLINE(  60)					max = button->get_height();
            				}
            			}
            		}
HXLINE(  63)		if ((max > 0)) {
...
HXLINE(  72)			Float x = this->_component->get_width();
HXDLIN(  72)			Float x1 = (x - left->get_width());
HXLINE(  73)			if (::hx::IsNotNull( right )) {
HXLINE(  74)				x1 = (x1 - right->get_width());
            			}
HXLINE(  76)			left->set_left((x1 + 1));
HXLINE(  77)			Float _hx_tmp2 = (this->_component->get_height() / ( (Float)(2) ));
HXDLIN(  77)			left->set_top((_hx_tmp2 - (left->get_height() / ( (Float)(2) ))));
            		}
...
HXLINE(  81)			Float _hx_tmp4 = this->_component->get_width();
HXDLIN(  81)			right->set_left((_hx_tmp4 - right->get_width()));
HXLINE(  82)			Float _hx_tmp5 = (this->_component->get_height() / ( (Float)(2) ));
HXDLIN(  82)			right->set_top((_hx_tmp5 - (right->get_height() / ( (Float)(2) ))));
            		}
            	}
...
HXDLIN(  89)				_g = (_g + 1);
HXLINE(  90)				if ((b->get_height() > max)) {
HXLINE(  91)					max = b->get_height();
            				}
            			}
            		}
