...
HX_DEFINE_STACK_FRAME(_hx_pos_c47a7887b785ba9e_280_new,"haxe.ui.components._TabBar.GetTab","new",0xe908fa88,"haxe.ui.components._TabBar.GetTab.new","haxe/ui/components/TabBar.hx",280,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_c47a7887b785ba9e_281_call,"haxe.ui.components._TabBar.GetTab","call",0xf789d176,"haxe.ui.components._TabBar.GetTab.call","haxe/ui/components/TabBar.hx",281,0xaabf3019)
namespace haxe{
namespace ui{
...
void GetTab_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_c47a7887b785ba9e_280_new)
...
bool GetTab_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::haxe::ui::util::VariantType GetTab_obj::call( ::Dynamic param){
            	HX_STACKFRAME(&_hx_pos_c47a7887b785ba9e_281_call)
HXLINE( 282)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_component->_compositeBuilder);
HXLINE( 283)		int index = ( (int)(param) );
HXLINE( 284)		 ::haxe::ui::core::Component tab = null();
HXLINE( 285)		 ::haxe::ui::containers::HBox _this = builder->_container;
HXDLIN( 285)		::Array< ::Dynamic> _hx_tmp;
HXDLIN( 285)		if (::hx::IsNull( _this->_children )) {
HXLINE( 285)			_hx_tmp = ::Array_obj< ::Dynamic>::__new(0);
            		}
            		else {
HXLINE( 285)			_hx_tmp = _this->_children;
            		}
HXDLIN( 285)		if ((index < _hx_tmp->length)) {
HXLINE( 286)			 ::haxe::ui::containers::HBox _this1 = builder->_container;
HXDLIN( 286)			::Array< ::Dynamic> tab1;
HXDLIN( 286)			if (::hx::IsNull( _this1->_children )) {
HXLINE( 286)				tab1 = ::Array_obj< ::Dynamic>::__new(0);
            			}
            			else {
HXLINE( 286)				tab1 = _this1->_children;
            			}
HXDLIN( 286)			tab = tab1->__get(index).StaticCast<  ::haxe::ui::core::Component >();
            		}
HXLINE( 288)		return ::haxe::ui::util::_Variant::Variant_Impl__obj::fromComponent(tab);
            	}
