...
HXLINE( 176)				rangeMax = (rangeMax - left->get_width());
...
HXLINE( 180)				rangeMax = (rangeMax - right->get_width());
            			}
...
HXLINE( 184)				Float max = builder->_container->get_width();
HXDLIN( 184)				Float max1 = -((max - this->_component->get_width()));
...
HXLINE( 187)					max1 = (max1 - left->get_width());
...
HXLINE( 191)					max1 = (max1 - right->get_width());
            				}
