...
HX_DEFINE_STACK_FRAME(_hx_pos_88f3884d2e7ae91a_309_new,"haxe.ui.components._TabBar.ButtonHeight","new",0x19ffbee2,"haxe.ui.components._TabBar.ButtonHeight.new","haxe/ui/components/TabBar.hx",309,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_88f3884d2e7ae91a_310_validateData,"haxe.ui.components._TabBar.ButtonHeight","validateData",0x509a871e,"haxe.ui.components._TabBar.ButtonHeight.validateData","haxe/ui/components/TabBar.hx",310,0xaabf3019)
namespace haxe{
namespace ui{
...
void ButtonHeight_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_88f3884d2e7ae91a_309_new)
...
void ButtonHeight_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_88f3884d2e7ae91a_310_validateData)
HXLINE( 311)		bool _hx_tmp;
HXDLIN( 311)		if (::hx::IsNotNull( this->_value )) {
HXLINE( 311)			_hx_tmp = ::haxe::ui::util::_Variant::Variant_Impl__obj::get_isNull(this->_value);
            		}
            		else {
...
HXLINE( 314)		{
HXLINE( 314)			int _g = 0;
HXDLIN( 314)			::Array< ::Dynamic> _g1 = this->_component->findComponents(null(),::hx::ClassOf< ::haxe::ui::components::Button >(),null());
HXDLIN( 314)			while((_g < _g1->length)){
HXLINE( 314)				 ::haxe::ui::components::Button b = _g1->__get(_g).StaticCast<  ::haxe::ui::components::Button >();
HXDLIN( 314)				_g = (_g + 1);
HXLINE( 315)				b->set_height(( (Float)(::haxe::ui::util::_Variant::Variant_Impl__obj::toFloat(this->_value)) ));
            			}
            		}
            	}
