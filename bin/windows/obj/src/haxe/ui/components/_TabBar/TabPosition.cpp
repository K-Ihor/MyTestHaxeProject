...
HX_DEFINE_STACK_FRAME(_hx_pos_cbc99741c1a83bb0_221_new,"haxe.ui.components._TabBar.TabPosition","new",0x387939f9,"haxe.ui.components._TabBar.TabPosition.new","haxe/ui/components/TabBar.hx",221,0xaabf3019)
HX_LOCAL_STACK_FRAME(_hx_pos_cbc99741c1a83bb0_222_validateData,"haxe.ui.components._TabBar.TabPosition","validateData",0x294a7127,"haxe.ui.components._TabBar.TabPosition.validateData","haxe/ui/components/TabBar.hx",222,0xaabf3019)
namespace haxe{
namespace ui{
...
void TabPosition_obj::__construct( ::haxe::ui::core::Component component){
            	HX_STACKFRAME(&_hx_pos_cbc99741c1a83bb0_221_new)
...
void TabPosition_obj::validateData(){
            	HX_STACKFRAME(&_hx_pos_cbc99741c1a83bb0_222_validateData)
HXLINE( 223)		 ::haxe::ui::components::_TabBar::Builder builder = ::hx::TCast<  ::haxe::ui::components::_TabBar::Builder >::cast(this->_component->_compositeBuilder);
HXLINE( 224)		 ::haxe::ui::util::VariantType _hx_tmp = this->_value;
HXDLIN( 224)		if (::haxe::ui::util::_Variant::Variant_Impl__obj::eq(_hx_tmp,::haxe::ui::util::_Variant::Variant_Impl__obj::fromString(HX_("bottom",eb,e6,78,65)))) {
HXLINE( 225)			this->_component->addClass(HX_(":bottom",a5,ce,55,d1),null(),null());
HXLINE( 226)			{
HXLINE( 226)				int _g = 0;
HXDLIN( 226)				 ::haxe::ui::containers::HBox _this = builder->_container;
HXDLIN( 226)				::Array< ::Dynamic> _g1;
HXDLIN( 226)				if (::hx::IsNull( _this->_children )) {
HXLINE( 226)					_g1 = ::Array_obj< ::Dynamic>::__new(0);
            				}
            				else {
HXLINE( 226)					_g1 = _this->_children;
            				}
HXDLIN( 226)				while((_g < _g1->length)){
HXLINE( 226)					 ::haxe::ui::core::Component child = _g1->__get(_g).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 226)					_g = (_g + 1);
HXLINE( 227)					child->addClass(HX_(":bottom",a5,ce,55,d1),null(),null());
            				}
            			}
            		}
            		else {
HXLINE( 230)			this->_component->removeClass(HX_(":bottom",a5,ce,55,d1),null(),null());
HXLINE( 231)			{
HXLINE( 231)				int _g2 = 0;
HXDLIN( 231)				 ::haxe::ui::containers::HBox _this1 = builder->_container;
HXDLIN( 231)				::Array< ::Dynamic> _g3;
HXDLIN( 231)				if (::hx::IsNull( _this1->_children )) {
HXLINE( 231)					_g3 = ::Array_obj< ::Dynamic>::__new(0);
            				}
            				else {
HXLINE( 231)					_g3 = _this1->_children;
            				}
HXDLIN( 231)				while((_g2 < _g3->length)){
HXLINE( 231)					 ::haxe::ui::core::Component child1 = _g3->__get(_g2).StaticCast<  ::haxe::ui::core::Component >();
HXDLIN( 231)					_g2 = (_g2 + 1);
HXLINE( 232)					child1->removeClass(HX_(":bottom",a5,ce,55,d1),null(),null());
            				}
            			}
            		}
            	}
