...
HXLINE(  53)			if ((tabs->get_height() != 0)) {
HXLINE(  54)				Float _hx_tmp1 = this->get_component()->get_height();
HXDLIN(  54)				Float _hx_tmp2 = (_hx_tmp1 - tabs->get_height());
...
HXLINE(  61)			if ((tabs->get_height() != 0)) {
