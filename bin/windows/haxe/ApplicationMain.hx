...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("HaxeProjectNEW1", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("HaxeProjectNEW1", null, 600, 490);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["build"] = "26";
		app.meta["company"] = "Ihor";
		app.meta["file"] = "HaxeProjectNEW1";
		app.meta["name"] = "HaxeProjectNEW1";
		app.meta["packageName"] = "HaxeProjectNEW1";
